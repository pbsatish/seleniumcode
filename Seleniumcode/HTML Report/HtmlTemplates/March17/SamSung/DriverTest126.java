...
public class DriverTest126  {
	

	public  String SBrowserType;

	
	public DriverTest126() {
		// TODO Auto-generated constructor stub
	}


	public  void Hello(int iRow)  {
	  ...
	  System.out.println("Excel Printing - :"+str);
	  
	  eat.PassPutCellData( "E://Batch2Source//Regression1.xls","Sheet1",iRow,4,str);
	...
	//  eat.workbook.close();
	  ...
	  /*
	   ...
	   System.out.println("sActions1Flag "+sActions1Flag);
	   	   	...
	   	   	if (sActions1Flag.equals("Yes"))
	   	   	{
		   		...
		   		System.out.println("Execution Falg is :" +sActions1Flag);
		    		...
		    		if (result2)
		    		{
		    			...
		    			eat3.PassPutCellData( "E://Batch2Source//Regression1.xls","Sheet1",iRow,4,"Passed");
		    		...
		    		else
		    		{
		    			...
		    			String str2="This Method is not implemented in Actions Class";
    			...
    			ExcelApiTest3 eat3 = new ExcelApiTest3();
    			String str3="Execution Falg is  No selected  ";
    			eat3.PutCellData( "E://Batch2Source//Regression1.xls","Sheet1",iRow,4,str3);
	   	   	}*/
