...
public class TestHTMLReporter3 {
		  ...
		  public   ArrayList<Integer>   TestSuitePAssFailCount()  throws Exception
		  {
		      ...
		      ArrayList<Integer> myArray = new ArrayList<Integer>();
				...
				ExcelApiTest3 eat1 = new ExcelApiTest3();
				 ...
				 for (int i=1;i<numberowsInputdata; i=i+6  )
				 {	


					 CellData6=eat1.getCellData(xlsFile,xlsFileSheet,i+5,1);
	...
	public String  CretaeHTMLFile(String TestName,String BrowserType) throws Exception
	{
		 ...
		 String HtmlOutputFileName= DynamicHtmlOutputFileFolderPath13 +".html";
			   ...
			   System.out.println("CellData4 is - "+CellData4);
...
public static boolean isNullOrEmpty(String str) {
	...
	public synchronized  void AppendCellData() throws Exception
	{
		
		/*
		TC01_Add Employee
		TC01_Add Employee_HTMLReport_2019_Mar_06_7_36_16 AM.html
		Chrome
		06-Mar-2019 7:36:16 AM
		1
		Pass
		*/

		
		ExcelAppendData(CellData1);
		ExcelAppendData(CellData2);
		ExcelAppendData(CellData3);
		ExcelAppendData(CellData4);
		
		SNo1=SNo1+1;
		CellData5=String.valueOf(SNo1);
		ExcelAppendData(CellData5);
		
		ExcelAppendData(CellData6);
		CellData6="";
	...
	//	 System.out.println("Test Name is :"+TestName);
		...
		fw.write("\n <th width=\"20%\"> Test Suite  : Mar-19 Release "
				+ "</th> ");	
	    ...
	    fw.write("\n <th width=\"15%\">Pass #  &nbsp; " + myArray.get(0) +
	    		"</th> ");
	    
	    fw.write("\n <th width=\"15%\">Fail #  &nbsp; " + myArray.get(1) +
	    		"</th> ");
		    ...
		    //  String CellData1="",CellData2="",CellData3="",CellData4="",CellData5="",CellData6="";
			 ...
			 {	
				 ...
				 // String s1 = String.valueOf(i); 
				  CellData1=eat1.getCellData(xlsFile,xlsFileSheet,i,1);
				  System.out.println("CellData1-"+CellData1);
				 
				 CellData2=eat1.getCellData(xlsFile,xlsFileSheet,i+1,1);
				 System.out.println("CellData2-"+CellData2);
				 
				 CellData3=eat1.getCellData(xlsFile,xlsFileSheet,i+2,1);
				 String  HtmlPath = CellData3.replace("\\", "/");
				 System.out.println("CellData3-"+CellData3);
				 
				 CellData4=eat1.getCellData(xlsFile,xlsFileSheet,i+3,1);
				 System.out.println("CellData4-"+CellData4);
				 
				 CellData5=eat1.getCellData(xlsFile,xlsFileSheet,i+4,1);
